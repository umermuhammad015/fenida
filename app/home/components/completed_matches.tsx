...
interface CompletedMatch {
    ...
    away_xg: number | null;
    date: Date | null; // Ensure it's a Date object, not a string
    ...
    // Add other properties that exist in your match object
}
                ...
                <div className="bg-background rounded-lg">
                    <div className=" p-4">
                        ...
                        <div className=" flex justify-between pt-6 gap-2">
                            {/* <button
                                className="border w-16 rounded-lg p-2"
                                onClick={show_previous}
                                style={{ color: completed_matches_count === completed_matches_length - 1 ? 'gray ' : undefined, cursor: completed_matches_count === completed_matches_length - 1 ? 'not-allowed' : undefined }}
                                disabled={completed_matches_count === completed_matches_length - 1 && true}>Previous
                            </button> */}
                            <button
                                onClick={show_previous}
                                // style={{ color: completed_matches_count === 0 && 'gray', cursor: completed_matches_count === 0 && 'not-allowed' }}
                                disabled={completed_matches_count === completed_matches_length - 1 && true}
                            ...
                            <button
                                onClick={show_next}
                                // style={{ color: completed_matches_count === 0 && 'gray', cursor: completed_matches_count === 0 && 'not-allowed' }}
                                disabled={completed_matches_count === 0 && true}
                                className={clsx(`border w-16 rounded-lg p-2 `, {
